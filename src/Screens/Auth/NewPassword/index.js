            ...
            <View style={container}>
                <KeyboardAwareScrollView enableOnAndroid={true}>
                    ...
                    <View style={{ height: hp('45%'), alignItems: 'center', justifyContent: "space-around", }}>
                        <View style={{ marginTop: 50, marginBottom: 20, marginHorizontal: 13, alignItems: 'flex-start', justifyContent: "flex-start", paddingLeft: 15 }}>
                            <Text style={{ width: wp('90%'), fontFamily: Font4, fontSize: hp(4), color: Colors.Black }}>New Password</Text>
                        ...
                        <View style={sc1Item2}>
                            <View style={inputView}>
                                <TextInput placeholder={'Password'} placeholderTextColor={Colors.MidGrey} style={inputField} />
                            </View>
                        </View>
                        <View style={sc1Item2}>
                            <View style={inputView}>
                                <TextInput placeholder={'Confirm Password'} placeholderTextColor={Colors.MidGrey} style={inputField} />
                            </View>
                        </View>
                    </View>
                    <View style={{ height: hp('50%'), padding: 20, alignItems: 'center', justifyContent: 'flex-end', }}>
                        ...
                        >
                            <Text style={{ fontFamily: "Poppins-SemiBold", color: Colors.White, fontSize: hp(2.5) }}>Reset</Text>
                        </TouchableOpacity>
                    </View>
